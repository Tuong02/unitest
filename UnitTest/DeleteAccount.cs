...
namespace UnitTest
{
    ...
    public class DeleteAccount
    {
        ...
        public void TestDeleteAcoount()
        {
            ...
            login.Click();
            Thread.Sleep(4000);
            IWebElement element = driver.FindElement(By.LinkText("Tài khoản"));
            element.Click();
            Thread.Sleep(3000);
            IWebElement firstRowdelete = wait.Until(d => d.FindElement(By.XPath("//tbody/tr[2]")));
            IWebElement detailButtondelete = wait.Until(d => d.FindElement(By.XPath(".//button[contains(., 'Xóa')]")));
